...
<Group id='EDID Configuration'>
    ...
    <ProductCode>0x7280</ProductCode>
    ...
    <VerticalScreenSize>0x0f</VerticalScreenSize>
...
<Group id='Detailed Timing'>
    ...
    <VerticalScreenSizeMM>0x96</VerticalScreenSizeMM>
...
<DSIInitSequence>
    ...
    FF 0A
    29 F0 5A 5A
    29 F2 00 05 0E 58 54 01 0C 00 04 26 E4 2F B0 0C 09 74 26 E4 0C 00 04 10 00 10 26 A8 10 00 10 10 34 10 00 40 30 C8 00 C8 00 00 CE
    29 35 00
    29 2A 00 00 04 37
    29 2B 00 00 09 5F
    29 FC 5A 5A
...
<Group id='Backlight Configuration'>
    <BacklightType>0</BacklightType>
    <BacklightPmicControlType>0</BacklightPmicControlType>
</Group>"})
